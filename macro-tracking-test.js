try {
  ...
  ga('create', 'UA-135430822-1', 'auto', 'testCampaign');
  ga( 'testCampaign.set', {
      'campaignSource': 'tenmax',
      'campaignName': 'tracking-impression',
  });
  ga( 'testCampaign.send', 'pageview');
   //get data
   ...
   function getTrackingLink() {
      ...
      return "https://g.jp.miaozhen.com/x/k=3005948&p=6qlmG&dx=0&rt=2&ns=__IP__&ni=__IESID__&v=__LOC__&tr=__REQUESTID__&mo=__OS__&m0=__OPENUDID__&m0a=__DUID__&m1=__ANDROIDID1__&m1a=__ANDROIDID__&m2=__IMEI__&m6=__MAC1__&m6a=__MAC__&m4=__AAID__&m5=__IDFA__&o=__TIMESTAMP__";
   }
   function getUrl() {
      var _document = null;
      try {
   ...
   console.log(err);
   ga('testCampaign.send', 'event', 'error',err, '');
}
